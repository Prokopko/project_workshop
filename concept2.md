...
**Высокий уровень ложноположительных срабатываний:** избыточное количество предупреждений требует дополнительной ручной фильтрации, что снижает эффективность автоматизации.
...
**Объектом исследования** являются смарт-контракты блокчейн-платформы Ethereum, написанные на языке программирования Solidity.

**Предметом исследования** выступают методы автоматизированного выявления уязвимого и мошеннического кода в смарт-контрактах на основе статического анализа и анализа бизнес-логики.
...
Научная новизна работы заключается в разработке **гибридного подхода** к автоматизированному выявлению уязвимого и мошеннического кода в смарт-контрактах, который сочетает:

1. **Паттерн-ориентированный статический анализ** для детектирования технических уязвимостей низкого уровня
2. **Семантический анализ бизнес-логики** через генеративные модели для выявления высокоуровневых мошеннических схем

Данный подход позволяет преодолеть ограничения существующих инструментов, которые либо фокусируются исключительно на технических уязвимостях, либо требуют полностью ручного анализа мошеннических схем.
